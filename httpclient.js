...
// here:
//
//  file:///home/ubuntu/.nvm/versions/node/v4.6.1/lib/node_modules/learnyounode/node_apidoc/http.html
// 
...
http.get(process.argv[2], (res) => {
    ...
    res.on('end', () => {
        try {
            rawData.forEach(element => console.log(element));
        }
        catch (err) {
